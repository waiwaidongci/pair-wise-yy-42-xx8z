...
RESOURCE_ENTITY='应急资源'; ASSIGNMENT_ENTITY='资源分配'
RESOURCE_ROLES=set(['logistics', 'incident_commander']); DISPATCH_ROLES=set(['field_commander', 'incident_commander']); RELEASE_ROLES=set(['incident_commander', 'logistics'])
