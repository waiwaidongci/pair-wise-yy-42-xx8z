...
class FailureTest(unittest.TestCase):
    ...
    def test_permission_version_duplicate_and_invariant(self):
        ...
        self.service.add_record(self.item["id"],payload,"recorder",'field_commander')
        with self.assertRaises(ConflictError): self.service.add_record(self.item["id"],payload,"recorder",'field_commander')
